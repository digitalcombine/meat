...
// class method is:
static Reference Class_cm_is_(Reference context) {
  Reference self = cast<Context>(context).self();
  Reference klass = cast<Context>(context).klass();
...
// class method isNot:
static Reference Class_cm_isNot_(Reference context) {
  Reference self = cast<Context>(context).self();
  Reference klass = cast<Context>(context).klass();
  Reference other = cast<Context>(context).parameter(0);
...
static Reference Class_cm_isWeakReference(Reference context) {
  Reference self = cast<Context>(context).self();
  Reference klass = cast<Context>(context).klass();
...
static Reference Class_cm_normalReference(Reference context) {
  Reference self = cast<Context>(context).self();
  Reference klass = cast<Context>(context).klass();
...
static Reference Class_cm_weakReference(Reference context) {
  Reference self = cast<Context>(context).self();
  Reference klass = cast<Context>(context).klass();
...
static meat::vtable_entry_t ClassCMethods[] = {
  {0x00000782, 0x03e2b958, VTM_BYTECODE, 6, {(meat::method_ptr_t)0}},
  {0x000007a0, 0x03e2b958, VTM_BYTECODE, 6, {(meat::method_ptr_t)18}},
  {0x00019850, 0x03e2b958, VTM_NATIVE  , 1, {(meat::method_ptr_t)Class_cm_is_}},
  {0x00337a8b, 0x03e2b958, VTM_NATIVE  , 0, {(meat::method_ptr_t)Class_cm_name}},
  {0x00368f3a, 0x03e2b958, VTM_BYTECODE, 5, {(meat::method_ptr_t)130}},
  ...
  {0x20be875b, 0x03e2b958, VTM_NATIVE  , 0, {(meat::method_ptr_t)Class_cm_weakReference}},
  {0x24ab71da, 0x03e2b958, VTM_NATIVE  , 0, {(meat::method_ptr_t)Class_cm_normalReference}},
  {0x34003578, 0x03e2b958, VTM_BYTECODE, 4, {(meat::method_ptr_t)36}},
  {0x39a68c12, 0x03e2b958, VTM_NATIVE  , 1, {(meat::method_ptr_t)Class_cm_isNot_}},
  {0x39a6a1d2, 0x03e2b958, VTM_BYTECODE, 6, {(meat::method_ptr_t)60}},
  ...
  {0x6b2d9a7a, 0x03e2b958, VTM_BYTECODE, 6, {(meat::method_ptr_t)83}},
  {0x7a8e569a, 0x03e2b958, VTM_BYTECODE, 6, {(meat::method_ptr_t)37}},
  {0x7b840562, 0x03e2b958, VTM_BYTECODE, 7, {(meat::method_ptr_t)106}},
  {0x7d180801, 0x03e2b958, VTM_NATIVE  , 0, {(meat::method_ptr_t)Class_cm_isWeakReference}}
};
...
static std::uint8_t ClassBytecode[] = {
  ...
  0x04, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01, 0x05, 0x0b, 0x0b, 0x13, 0x05,
  0x67, 0x14, 0x04, 0x24, 0x02, 0x05, 0x04, 0x00, 0x36, 0x75, 0x8e, 0x00, 0x01,
  0x02, 0x41, 0x79, 0x69, 0x3a, 0x01, 0x04, 0x0b, 0x13, 0x05, 0x67, 0x14, 0x04,
  0x24, 0x02, 0x05, 0x04, 0x05, 0xcb, 0x19, 0x23, 0x00, 0x01, 0x02, 0x41, 0x79,
  0x69, 0x3a, 0x01, 0x04, 0x0b, 0x13, 0x05, 0x67, 0x14, 0x04, 0x24, 0x02, 0x05,
  0x04, 0x05, 0xcb, 0x19, 0x23, 0x00, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01,
  0x04, 0x0b, 0x13, 0x06, 0x03, 0xe2, 0xb9, 0x58, 0x02, 0x06, 0x05, 0x00, 0x00,
  0x07, 0xa0, 0x01, 0x04, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01, 0x05, 0x0b,
  0x13, 0x04, 0x03, 0xe2, 0xb9, 0x58, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01,
  0x04, 0x0b
};
...
static meat::vtable_entry_t ObjectMethods[] = {
  ...
  {0x331152ee, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x34003578, 0x0c658f60, VTM_BYTECODE, 4, {(meat::method_ptr_t)36}},
  {0x39a68c12, 0x0c658f60, VTM_NATIVE  , 1, {(meat::method_ptr_t)Object_om_isNot_}},
  {0x39a6a1d2, 0x0c658f60, VTM_BYTECODE, 6, {(meat::method_ptr_t)60}},
  {0x48dbf560, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x6b2d9a7a, 0x0c658f60, VTM_BYTECODE, 6, {(meat::method_ptr_t)83}},
  {0x7a8e569a, 0x0c658f60, VTM_BYTECODE, 6, {(meat::method_ptr_t)37}},
...
static std::uint8_t ObjectBytecode[] = {
  ...
  0x69, 0x3a, 0x01, 0x05, 0x0b, 0x02, 0x00, 0x05, 0x00, 0x01, 0x98, 0x50, 0x01,
  0x04, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01, 0x05, 0x0b, 0x0b, 0x13, 0x05,
  0x67, 0x14, 0x04, 0x24, 0x02, 0x05, 0x04, 0x05, 0xcb, 0x19, 0x23, 0x00, 0x01,
  0x02, 0x41, 0x79, 0x69, 0x3a, 0x01, 0x04, 0x0b, 0x13, 0x05, 0x67, 0x14, 0x04,
  0x24, 0x02, 0x05, 0x04, 0x05, 0xcb, 0x19, 0x23, 0x00, 0x01, 0x02, 0x41, 0x79,
  0x69, 0x3a, 0x01, 0x04, 0x0b, 0x13, 0x05, 0x67, 0x14, 0x04, 0x24, 0x02, 0x05,
  0x04, 0x00, 0x36, 0x75, 0x8e, 0x00, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01,
  0x04, 0x0b
};
...
// method returnTo:
static Reference Context_om_returnTo_(Reference context) {
  Reference self = cast<Context>(context).self();
  Reference klass = cast<Context>(context).klass();
  Reference otherContext = cast<Context>(context).parameter(0);
...
static meat::vtable_entry_t ContextMethods[] = {
  ...
  {0x48c473ea, 0x1befcdac, VTM_NATIVE  , 1, {(meat::method_ptr_t)Context_om_returnTo_}},
  {0x48dbf560, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
...
static std::uint8_t ContextBytecode[] = {
  0x0b, 0x0b, 0x13, 0x06, 0x4f, 0xc2, 0x61, 0x66, 0x02, 0x02, 0x04, 0x72, 0x79,
  0x75, 0xfa, 0x00, 0x16, 0x05, 0x43, 0x61, 0x6e, 0x6e, 0x6f, 0x74, 0x20, 0x63,
  0x72, 0x65, 0x61, 0x74, 0x65, 0x20, 0x61, 0x20, 0x6e, 0x65, 0x77, 0x20, 0x69,
  0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x20, 0x43, 0x6f, 0x6e, 0x74, 0x65,
  0x78, 0x74, 0x20, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x00, 0x01, 0x06, 0x6d,
  0xb6, 0x8a, 0xb6, 0x02, 0x05, 0x04, 0x0b
};
...
static meat::vtable_entry_t BlockContextMethods[] = {
  ...
  {0x675bde74, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x6b2d9a7a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
...
static std::uint8_t NullBytecode[] = {
  
};
...
#define _message (self->property(0))
#define _context (self->property(1))

#define _exceptionBlock (klass->property(0))
#define _exceptionParameter (klass->property(1))
#define _returnContext (klass->property(2))

static meat::vtable_entry_t Exception2Methods[] = {
  {0x00000782, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x000007a0, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x00019850, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x00368f3a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  ...
  {0x331152ee, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x34003578, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x38b735d9, 0x2889cb9f, VTM_BYTECODE, 5, {(meat::method_ptr_t)0}},
  {0x38eb0035, 0x2889cb9f, VTM_BYTECODE, 5, {(meat::method_ptr_t)12}},
  {0x39a68c12, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x39a6a1d2, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x48dbf560, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x6b2d9a7a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
...
static meat::vtable_entry_t Exception2CMethods[] = {
  {0x00000782, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x000007a0, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x00019850, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x003675df, 0x2889cb9f, VTM_BYTECODE, 9, {(meat::method_ptr_t)224}},
  {0x00368f3a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x068b6f7b, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x20be875b, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x24ab71da, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x39a68c12, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x39a6a1d2, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x4be13615, 0x2889cb9f, VTM_BYTECODE, 8, {(meat::method_ptr_t)24}},
  {0x4e48308e, 0x2889cb9f, VTM_BYTECODE, 11, {(meat::method_ptr_t)294}},
  {0x54aa30e6, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x6b2d9a7a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x6db68ab6, 0x2889cb9f, VTM_BYTECODE, 9, {(meat::method_ptr_t)128}},
  {0x7a8e569a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x7b840562, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x7bebbd56, 0x2889cb9f, VTM_BYTECODE, 10, {(meat::method_ptr_t)259}},
  {0x7d180801, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}}
};

#undef _exceptionBlock
#undef _exceptionParameter
#undef _returnContext

static std::uint8_t Exception2Bytecode[] = {
  
};
...
static std::uint8_t BooleanBytecode[] = {
  ,
...
#define blockContext (self->property(0))
#define localIndex (self->property(1))
...
static meat::vtable_entry_t BlockParameterMethods[] = {
  ...
  {0x20be875b, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x24ab71da, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x2536833e, 0x0efec3f6, VTM_BYTECODE, 7, {(meat::method_ptr_t)24}},
  {0x331152ee, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x34003578, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x39a68c12, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x39a6a1d2, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x48dbf560, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x6b2d9a7a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x754a3d0d, 0x0efec3f6, VTM_BYTECODE, 7, {(meat::method_ptr_t)0}},
  {0x7a8e569a, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x7b840562, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}},
  {0x7d180801, 0x00000000, VTM_SUPER   , 0, {(meat::method_ptr_t)0}}
};
...
static std::uint8_t BlockParameterBytecode[] = {
  0x11, 0x05, 0x00, 0x11, 0x06, 0x01, 0x02, 0x05, 0x04, 0x23, 0xad, 0xd6, 0x2f,
  0x01, 0x06, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01, 0x04, 0x0b, 0x11, 0x05,
  0x00, 0x11, 0x06, 0x01, 0x01, 0x05, 0x67, 0x5b, 0xde, 0x74, 0x02, 0x06, 0x04,
  0x0b
};
...
static std::uint8_t NumericBytecode[] = {
  ,
  ...
  ,
  ...
  0x6f, 0x20, 0x54, 0x65, 0x78, 0x74, 0x00, 0x01, 0x05, 0x4b, 0xe1, 0x36, 0x15,
  0x01, 0x04, 0x0b, 0x13, 0x05, 0x4f, 0xc2, 0x61, 0x66, 0x16, 0x04, 0x4d, 0x65,
  ...
  0x4b, 0xe1, 0x36, 0x15, 0x01, 0x04, 0x0b, 0x13, 0x05, 0x4f, 0xc2, 0x61, 0x66,
  0x16, 0x04, 0x4e, 0x75, 0x6d, 0x65, 0x72, 0x69, 0x63, 0x20, 0x76, 0x61, 0x6c,
  0x75, 0x65, 0x20, 0x68, 0x61, 0x73, 0x20, 0x6e, 0x6f, 0x20, 0x6d, 0x69, 0x6e,
  0x69, 0x6d, 0x75, 0x6d, 0x20, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x00, 0x01, 0x05,
  0x4b, 0xe1, 0x36, 0x15, 0x01, 0x04, 0x0b, 0x13, 0x05, 0x4f, 0xc2, 0x61, 0x66,
  0x16, 0x04, 0x4e, 0x75, 0x6d, 0x65, 0x72, 0x69, 0x63, 0x20, 0x76, 0x61, 0x6c,
  0x75, 0x65, 0x20, 0x68, 0x61, 0x73, 0x20, 0x6e, 0x6f, 0x20, 0x6d, 0x69, 0x6e,
  0x69, 0x6d, 0x75, 0x6d, 0x20, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x00, 0x01, 0x05,
  0x4b, 0xe1, 0x36, 0x15, 0x01, 0x04, 0x0b
};
...
static std::uint8_t ApplicationBytecode[] = {
  0x13, 0x05, 0x4f, 0xc2, 0x61, 0x66, 0x16, 0x04, 0x41, 0x70, 0x70, 0x6c, 0x69,
  ...
  0x01, 0x05, 0x4b, 0xe1, 0x36, 0x15, 0x01, 0x04, 0x0b, 0x13, 0x05, 0x4f, 0xc2,
  0x61, 0x66, 0x16, 0x04, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69,
  ...
  0x6e, 0x00, 0x01, 0x05, 0x4b, 0xe1, 0x36, 0x15, 0x01, 0x04, 0x0b
};
...
static std::uint8_t LibraryBytecode[] = {
  0x11, 0x07, 0x00, 0x02, 0x04, 0x05, 0x7b, 0x82, 0xe3, 0x2c, 0x00, 0x02, 0x07,
  0x06, 0x00, 0x00, 0x00, 0x3c, 0x01, 0x05, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a,
  0x01, 0x06, 0x0b, 0x11, 0x05, 0x02, 0x02, 0x05, 0x04, 0x00, 0x2e, 0xaf, 0x75,
  0x00, 0x01, 0x02, 0x41, 0x79, 0x69, 0x3a, 0x01, 0x04, 0x0b, 0x11, 0x04, 0x00,
...
static std::uint8_t Symbols[] = {
  ...
  "BlockContext\0BlockParameter\0Boolean\0Boolean\0Class\0Class\0"
  "Context\0Exception\0Exception2\0Exception\0Index\0Index\0"
  "Integer\0Library\0List\0List\0Null\0Number\0Numeric\0"
  "Object\0Object\0Set\0Text\0^\0absolute\0and:\0append:\0asInteger\0"
  "asLowercase\0asNumber\0asText\0asUppercase\0at:insert:\0break\0clear\0"
  "context\0continue\0copy\0create:\0entries\0entry\0execute\0"
  ...
  "getName\0getObject\0getValue\0has:\0hasEntry:\0import:\0include:\0"
  "initialize\0insert:\0is:\0isClass\0isEmpty\0isFalse:\0isFalse:else:\0"
  "isNot:\0isNull\0isObject\0isTrue:\0isTrue:else:\0isType:\0isWeakReference\0"
  "last\0length\0localVariables\0lshift\0lshift:\0maxValue\0message\0"
  "messenger\0minValue\0name\0negative\0new\0newObject\0normalReference\0not\0"
  "object\0open:\0or:\0parameter:\0parameters\0pop\0popFront\0push:\0"
  "pushFront:\0remove:\0removeAt:\0removeFrom:to:\0repeat:\0replaceAll:with:\0"
  "replaceFrom:count:with:\0requires:\0reset\0return\0return:\0returnTo:\0"
  "rshift\0rshift:\0set:to:\0setApplicationClass:\0setLocal:to:\0setObject:\0"
  "setValueTo:\0sort\0subclass:as:\0superClass\0swap:\0swap:with:\0sync\0"
...
void meat::initialize(int argc, const char *argv[]) {
  ...
  class_cls->set_vtable(15, ClassMethods, meat::STATIC);
  class_cls->set_class_vtable(19, ClassCMethods, meat::STATIC);
  class_cls->bytecode(145, ClassBytecode, meat::STATIC);
  ...
  object_cls->set_vtable(16, ObjectMethods, meat::STATIC);
  object_cls->set_class_vtable(14, ObjectCMethods, meat::STATIC);
  object_cls->bytecode(106, ObjectBytecode, meat::STATIC);
  ...
  context_cls->set_class_vtable(14, ContextCMethods, meat::STATIC);
  context_cls->bytecode(72, ContextBytecode, meat::STATIC);
  Class::record(context_cls, "Context");

  // Register class BlockContext.
  Class *blockcontext_cls = new meat::Class(meat::Class::resolve(0x1befcdac), 0, 0);
  blockcontext_cls->set_vtable(31, BlockContextMethods, meat::STATIC);
  ...
  null_cls->set_vtable(17, NullMethods, meat::STATIC);
  ...
  // Register class Exception2.
  Class *exception2_cls = new meat::Class(meat::Class::resolve(0x0c658f60), 3, 2);
  exception2_cls->set_vtable(18, Exception2Methods, meat::STATIC);
  exception2_cls->set_class_vtable(19, Exception2CMethods, meat::STATIC);
  exception2_cls->bytecode(329, Exception2Bytecode, meat::STATIC);
  Class::record(exception2_cls, "Exception2");

  // Register class Boolean.
  Class *boolean_cls = new meat::Class(meat::Class::resolve(0x0c658f60), 2, 0);
  boolean_cls->set_vtable(25, BooleanMethods, meat::STATIC);
  ...
  // Register class BlockParameter.
  Class *blockparameter_cls = new meat::Class(meat::Class::resolve(0x0c658f60), 0, 2);
  ...
  blockparameter_cls->bytecode(40, BlockParameterBytecode, meat::STATIC);
  Class::record(blockparameter_cls, "BlockParameter");

  // Register class Numeric.
  Class *numeric_cls = new meat::Class(meat::Class::resolve(0x0c658f60), 0, 0);
  numeric_cls->set_vtable(29, NumericMethods, meat::STATIC);
  ...
  integer_cls->set_vtable(37, IntegerMethods, meat::STATIC);
  ...
  number_cls->set_vtable(29, NumberMethods, meat::STATIC);
  ...
  text_cls->set_vtable(39, TextMethods, meat::STATIC);
  ...
  list_cls->set_vtable(36, ListMethods, meat::STATIC);
  ...
  set_cls->set_vtable(25, SetMethods, meat::STATIC);
  ...
  index_cls->set_vtable(23, IndexMethods, meat::STATIC);
  ...
  application_cls->set_vtable(17, ApplicationMethods, meat::STATIC);
  ...
  // Register class Archive.
  Class *archive_cls = new meat::Class(meat::Class::resolve(0x0c658f60), 0, 0);
  archive_cls->set_vtable(20, ArchiveMethods, meat::STATIC);
  ...
  library_cls->set_vtable(19, LibraryMethods, meat::STATIC);
  ...
  library->add(exception2_cls, "Exception2");
